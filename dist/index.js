module.exports = (function(e, t) {
  ...
  9: function(e, t, r) {
    ...
    var s = function(e, t, r) {
      if (typeof t === "function") return s(e, null, t);
      if (!t) t = {};
      r = p(r || a);
  ...
  20: function(e, t, r) {
    ...
    function spawn(e, t, r) {
      const d = a(e, t, r);
      const s = p.spawn(d.command, d.args, d.options);
      i.hookChildProcess(s, d);
      return s;
    }
    function spawnSync(e, t, r) {
      const d = a(e, t, r);
      const s = p.spawnSync(d.command, d.args, d.options);
      s.error = s.error || i.verifyENOENTSync(s.status, d);
      return s;
    }
    e.exports = spawn;
  ...
  25: function(e, t, r) {
    ...
    function createDebug(e) {
      ...
      function debug() {
        ...
        var n = debug.log || t.log || console.log.bind(console);
        n.apply(e, i);
      }
      debug.namespace = e;
  ...
  104: function(e, t, r) {
    ...
    const i = r(0);
    const { GIST_ID: d, GH_TOKEN: s, WAKATIME_API_KEY: n } = process.env;
    const o = new p(n);
    const m = new i({ auth: `token ${s}` });
    async function main() {
  ...
  126: function(e) {
    ...
    var m = n || o || Function("return this")();
    ...
    function hashHas(e) {
      var t = this.__data__;
      return T ? t[e] !== undefined : y.call(t, e);
    }
    ...
    function baseIsNative(e) {
      ...
      var t = isFunction(e) || isHostObject(e) ? w : s;
    ...
    e.exports = function xhrAdapter(e) {
      return new Promise(function dispatchXhrRequest(t, o) {
        ...
        l.onabort = function handleAbort() {
          ...
          o(n("Request aborted", e, "ECONNABORTED", l));
          l = null;
        };
        l.onerror = function handleError() {
          o(n("Network Error", e, null, l));
          l = null;
        };
        l.ontimeout = function handleTimeout() {
          o(n("timeout of " + e.timeout + "ms exceeded", e, "ECONNABORTED", l));
          l = null;
        };
  ...
  260: function(e, t, r) {
    ...
    if (!a(p)) {
      ...
      if (p.__signal_exit_emitter__) {
        ...
        o = p.__signal_exit_emitter__ = new n();
        o.count = 0;
        o.emitted = {};
      }
      if (!o.infinite) {
      ...
      var y = p.emit;
      var v = function processEmit(e, t) {
  ...
  265: function(e, t, r) {
    ...
    function getPage(e, t, r, d) {
      ...
      const n = { url: s, headers: applyAcceptHeader(t, d) };
      const o = e.request(n);
      return o;
    }
  ...
  301: function(e, t, r) {
    ...
    function normalizePaginatedListResponse(e, t, r) {
      ...
      if (!n.test(a) && !o.test(a) && !m.test(a) && !u.test(a) && !l.test(a)) {
        return;
      }
    ...
    function validate(e, t) {
      ...
      Object.keys(r).forEach(e => {
        ...
        if (/\./.test(e)) {
          ...
          o = a(t, n);
          m = n === "headers" || (typeof o === "object" && o !== null);
        }
        const l = u
          ? (a(t, n) || []).map(t => t[e.split(/\./).pop()])
          : [a(t, e)];
        l.forEach((r, a) => {
  ...
  352: function(e, t, r) {
    ...
    var n = createInstance(s);
    n.Axios = i;
    n.create = function create(e) {
      return createInstance(d(n.defaults, e));
    };
    n.Cancel = r(826);
    n.CancelToken = r(137);
    n.isCancel = r(732);
    n.all = function all(e) {
  ...
  385: function(e, t, r) {
    ...
    const d = "6.0.12";
    const s = `octokit-endpoint.js/${d} ${a.getUserAgent()}`;
    const n = {
      method: "GET",
  ...
  402: function(e, t, r) {
    ...
    function Octokit(e, t) {
      ...
      const s = { hook: r, log: d, request: p.defaults(i(t, d, r)) };
      e.forEach(e => e(s, t));
      return s;
    }
  },
  ...
  453: function(e, t, r) {
    ...
    var i = r(747);
    var d = function() {};
    var s = /^v?\.0/.test(process.version);
    var n = function(e) {
    ...
    var u = function(e, t, r, i) {
      ...
      return function(t) {
        ...
        if (n(e.destroy)) return e.destroy();
    ...
    var h = function() {
      ...
      var t = (n(e[e.length - 1] || d) && e.pop()) || d;
  ...
  454: function(e, t, r) {
    ...
    const j = function isDomainOrSubdomain(e, t) {
    ...
    function fetch(e, t) {
      ...
      return new fetch.Promise(function(r, i) {
        ...
        const m = (o.protocol === "https:" ? s : a).request;
        const u = d.signal;
        let l = null;
        ...
        g.on("response", function(e) {
          ...
          const o = { flush: n.Z_SYNC_FLUSH, finishFlush: n.Z_SYNC_FLUSH };
          if (s == "gzip" || s == "x-gzip") {
            p = p.pipe(n.createGunzip(o));
            l = new Response(p, a);
            r(l);
            return;
          }
          if (s == "deflate" || s == "x-deflate") {
            ...
            t.once("data", function(e) {
              if ((e[0] & 15) === 8) {
                p = p.pipe(n.createInflate());
              } else {
                p = p.pipe(n.createInflateRaw());
              }
              l = new Response(p, a);
              r(l);
            });
          ...
          if (s == "br" && typeof n.createBrotliDecompress === "function") {
            p = p.pipe(n.createBrotliDecompress());
            l = new Response(p, a);
            r(l);
            return;
          }
  ...
  523: function(e, t, r) {
    ...
    function bindApi(e, t, r) {
      var p = s(i, null).apply(null, r ? [t, r] : [t]);
      e.api = { remove: p };
      e.remove = p;
      ["before", "error", "after", "wrap"].forEach(function(p) {
        var i = r ? [t, p, r] : [t, p];
        e[p] = e.api[p] = s(a, null).apply(null, i);
      });
    }
  ...
  530: function(e, t, r) {
    ...
    function mapChars(e, t, r) {
      ...
      for (var s = 0; s < d; ++s) {
        var n = e.codePointAt(s);
        var o = findStatus(n);
        switch (o[1]) {
          case "disallowed":
            p = true;
            a += String.fromCodePoint(n);
            break;
          case "ignored":
            break;
          case "mapped":
    ...
    function validateLabel(e, t) {
      ...
      for (var d = 0; d < a; ++d) {
        var n = findStatus(e.codePointAt(d));
        if (
          (processing === i.TRANSITIONAL && n[1] !== "valid") ||
    ...
    e.exports.toASCII = function(e, t, r, a) {
      ...
      if (a) {
        var s = d.slice(0, d.length - 1).join(".").length;
  ...
  549: function(e, t, r) {
    ...
    var i = r(211);
    var d = r(357);
    var s = r(413).Writable;
    var n = r(784)("follow-redirects");
    ...
    RedirectableRequest.prototype = Object.create(s.prototype);
  ...
  568: function(e, t, r) {
    ...
    const l =
      a(() =>
        n.satisfies(process.version, "^4.8.0 || ^5.7.0 || >= 6.0.0", true)
      ) || false;
    ...
    var i,
      ...
      n = function() {
        var e =
          ...
          a = void 0 === p ? null : p,
          i = e.projectName;
        return { timeout: r, writes_only: a, project: void 0 === i ? null : i };
      },
      o = function(e) {
        var t = e.date,
          r = e.projectName,
      ...
      m = function() {
        var e =
          ...
          r = void 0 === t ? null : t,
          p = e.pageNumber;
        return { author: r, page: void 0 === p ? null : p };
      },
      u = Object.freeze(
        (_defineProperty((i = {}), d.LAST_7_DAYS, "last_7_days"),
        _defineProperty(i, d.LAST_30_DAYS, "last_30_days"),
        _defineProperty(i, d.LAST_6_MONTHS, "last_6_months"),
        _defineProperty(i, d.LAST_YEAR, "last_year"),
        i)
      ),
      l = (function() {
        function e(t) {
          _classCallCheck(this, e),
            (this.apiKey = t),
            (this.axiosConfiguration = a.create({
          ...
          _createClass(e, [
            ...
            },
            {
              ...
              value: function(e) {
                var t = e.teamId,
                  r = e.teamMemberId,
                  p = _objectWithoutProperties(e, ["teamId", "teamMemberId"]);
                return this.axiosConfiguration
                  .get(
                    "users/current/teams/"
                      .concat(t, "/members/")
            ...
            },
            {
              ...
              value: function(e) {
                ...
                return this.axiosConfiguration
                  .get("users/".concat(t, "/summaries"), { params: s(r) })
                  .then(function(e) {
                    return e.data;
                  });
              }
            },
            {
              ...
              value: function(e) {
                var t = _extends({}, e);
                return this.axiosConfiguration
                  .get("users/current/summaries", { params: s(t) })
                  .then(function(e) {
                    return e.data;
                  });
              }
            },
            {
              ...
              value: function(e) {
                var t = e.userId,
                  r = e.range,
                  p = _objectWithoutProperties(e, ["userId", "range"]);
                return this.axiosConfiguration
                  .get("users/".concat(t, "/stats/").concat(u[r]), {
                    params: n(p)
                  })
                  .then(function(e) {
                    return e.data;
            ...
            },
            {
              ...
              value: function(e) {
                ...
                return this.axiosConfiguration
                  .get("users/current/stats/".concat(u[t]), { params: n(r) })
                  .then(function(e) {
                    return e.data;
                  });
              }
            ...
            },
            {
              ...
              value: function(e) {
                var t = e.userId,
                  r = _objectWithoutProperties(e, ["userId"]);
                return this.axiosConfiguration
                  .get("users/".concat(t, "/durations"), { params: o(r) })
                  .then(function(e) {
                    return e.data;
                  });
              }
            },
            {
              ...
              value: function(e) {
                var t = _extends({}, e);
                return this.axiosConfiguration
                  .get("users/current/durations", { params: o(t) })
                  .then(function(e) {
                    return e.data;
                  });
              }
            },
            {
              ...
              value: function(e) {
                var t = e.userId,
                  r = e.projectName,
                  p = _objectWithoutProperties(e, ["userId", "projectName"]);
                return this.axiosConfiguration
  ...
  670: function(e, t, r) {
    ...
    e.exports = function httpAdapter(e) {
      return new Promise(function dispatchHttpRequest(t, r) {
        ...
        var j = g.test(S);
        var A = j ? e.httpsAgent : e.httpAgent;
        var V = {
        ...
        var O = e.proxy;
        if (!O && O !== false) {
          var P = S.slice(0, -1) + "_proxy";
          var R = process.env[P] || process.env[P.toUpperCase()];
          if (R) {
            var x = m.parse(R);
            var k = process.env.no_proxy || process.env.NO_PROXY;
            var F = true;
            if (k) {
              var B = k.split(",").map(function trim(e) {
                return e.trim();
              });
        ...
        var U;
        var I = j && (O ? g.test(O.protocol) : true);
        if (e.transport) {
          U = e.transport;
        ...
        var H = U.request(V, function handleResponse(t) {
          if (H.aborted) return;
          var r = t;
        ...
        if (e.timeout) {
          f = setTimeout(function handleRequestTimeout() {
            H.abort();
            v(
              c("timeout of " + e.timeout + "ms exceeded", e, "ECONNABORTED", H)
            );
          }, e.timeout);
        }
        if (e.cancelToken) {
  ...
  753: function(e, t, r) {
    ...
    function fetchWrapper(e) {
      ...
      let p;
      let a;
      const n = (e.request && e.request.fetch) || d;
      return n(
        e.url,
        Object.assign(
          {
        ...
        .then(async i => {
          ...
          if (e.method === "HEAD") {
            ...
            throw new s.RequestError(i.statusText, p, {
              response: { url: a, status: p, headers: r, data: undefined },
              request: e
            });
          }
          if (p === 304) {
            throw new s.RequestError("Not modified", p, {
              response: {
                url: a,
                status: p,
                headers: r,
          ...
          if (p >= 400) {
            ...
            const d = new s.RequestError(toErrorMessage(t), p, {
    ...
    const o = withDefaults(p.endpoint, {
      headers: { "user-agent": `octokit-request.js/${n} ${a.getUserAgent()}` }
    });
    t.request = o;
  },
  761: function(e) {
  ...
  766: function(e, t) {
    ...
    Comparator.prototype.parse = function(e) {
      var t = this.options.loose ? d[I] : d[H];
      var r = e.match(t);
      if (!r) {
    ...
    function replaceXRange(e, t) {
      e = e.trim();
      var p = t.loose ? d[A] : d[j];
      return e.replace(p, function(t, p, a, i, d, s) {
        r("xRange", e, t, p, a, i, d, s);
        var n = isX(a);
        var o = n || isX(i);
        var m = o || isX(d);
        var u = m;
    ...
    function replaceStars(e, t) {
      r("replaceStars", e, t);
      return e.trim().replace(d[X], "");
    }
    function hyphenReplace(e, t, r, p, a, i, d, s, n, o, m, u, l) {
      if (isX(r)) {
        t = "";
      } else if (isX(p)) {
        t = ">=" + r + ".0.0";
    ...
    function outside(e, t, r, p) {
      ...
      for (var o = 0; o < t.set.length; ++o) {
        ...
        if (u.operator === s || u.operator === n) {
          return false;
        }
        if ((!l.operator || l.operator === s) && i(e, l.semver)) {
          return false;
        } else if (l.operator === n && d(e, l.semver)) {
          return false;
        }
      }
      return true;
  ...
  814: function(e, t, r) {
    ...
    function getPathInfo(e, t) {
      ...
      if (p) {
        ...
        s = t.pathExt || process.env.PATHEXT || ".EXE;.CMD;.BAT;.COM";
        d = s.split(r);
        if (e.indexOf(".") !== -1 && d[0] !== "") d.unshift("");
      }
      if (e.match(/\//) || (p && e.match(/\\/))) a = [""];
      return { env: a, ext: d, extExe: s };
    }
  ...
  854: function(e) {
    ...
    var N = getNative(f, "Map"),
      j = getNative(Object, "create");
    var A = C ? C.prototype : undefined,
      V = A ? A.toString : undefined;
    function Hash(e) {
      var t = -1,
        r = e ? e.length : 0;
      this.clear();
    ...
    function hashHas(e) {
      var t = this.__data__;
      return j ? t[e] !== undefined : T.call(t, e);
    }
    function hashSet(e, t) {
      var p = this.__data__;
      p[e] = j && t === undefined ? r : t;
      return this;
    }
    Hash.prototype.clear = hashClear;
    Hash.prototype["delete"] = hashDelete;
    ...
    function isKey(e, t) {
      ...
      return n.test(e) || !s.test(e) || (t != null && e in Object(t));
    }
    function isKeyable(e) {
      var t = typeof e;
      return t == "string" || t == "number" || t == "symbol" || t == "boolean"
  ...
  883: function(e) {
    ...
    function isKey(e, t) {
      ...
      return o.test(e) || !n.test(e) || (t != null && e in Object(t));
    }
    function isKeyable(e) {
      var t = typeof e;
      return t == "string" || t == "number" || t == "symbol" || t == "boolean"
    ...
    function isSymbol(e) {
      return typeof e == "symbol" || (isObjectLike(e) && C.call(e) == s);
    }
    function toString(e) {
      return e == null ? "" : baseToString(e);
    }
    ...
    function registerEndpoints(e, t) {
      Object.keys(t).forEach(r => {
        ...
        Object.keys(t[r]).forEach(a => {
          ...
          let s = e.request.defaults(d);
          const n = Object.keys(i.params || {}).find(
            e => i.params[e].deprecated
          );
          if (n) {
            const t = patchForDeprecation.bind(null, e, i);
            s = t(e.request.defaults(d), `.${r}.${a}()`);
            s.endpoint = t(s.endpoint, `.${r}.${a}.endpoint()`);
            s.endpoint.merge = t(
              s.endpoint.merge,
              `.${r}.${a}.endpoint.merge()`
            );
  ...
  946: function(e, t, r) {
    ...
    e.exports = function dispatchRequest(e) {
      ...
      if (e.baseURL && !s(e.url)) {
        e.url = n(e.baseURL, e.url);
      }
      e.headers = e.headers || {};
  ...
  955: function(e, t, r) {
    ...
    function handleArgs(e, t, r) {
      ...
      r.stdio = c(r);
      if (r.preferLocal) {
        r.env = s.env(Object.assign({}, r, { cwd: r.localDir }));
      }
      if (r.detached) {
        r.cleanup = false;
      }
    ...
    function makeError(e, t) {
      ...
      const { parsed: s, joinedCmd: n } = t;
      const o = t.timedOut || false;
      if (!a) {
        let e = "";
        if (Array.isArray(s.opts.stdio)) {
          if (s.opts.stdio[2] !== "inherit") {
            e += e.length > 0 ? p : `\n${p}`;
          }
          if (s.opts.stdio[1] !== "inherit") {
            e += `\n${r}`;
          }
        } else if (s.opts.stdio !== "inherit") {
          e = `\n${p}${r}`;
        }
        a = new Error(`Command failed: ${n}${e}`);
        a.code = i < 0 ? l(i) : i;
      }
      a.stdout = r;
      a.stderr = p;
    ...
    e.exports = (e, t, r) => {
      ...
      const { encoding: d, buffer: s, maxBuffer: n } = p.opts;
      const o = joinCmd(e, t);
      let l;
      try {
      ...
      const v = () =>
        m(
          Promise.all([
            y,
            getStream(l, "stdout", { encoding: d, buffer: s, maxBuffer: n }),
            getStream(l, "stderr", { encoding: d, buffer: s, maxBuffer: n })
          ]).then(e => {
            const t = e[0];
            t.stdout = e[1];
            t.stderr = e[2];
  ...
  966: function(e, t, r) {
    ...
    e.exports = e => {
      ...
      n.getBufferedValue = () => {
        ...
        return a ? Buffer.concat(s, d) : s.join("");
      };
      n.getBufferedLength = () => d;
      return n;
    };
  },
  967: function(e) {
